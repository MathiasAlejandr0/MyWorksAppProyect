    ...
    >
      ...
      <div
        style={{
          ...
          height: '550px',
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(240, 120, 42, 0.32) 0%, rgba(255, 107, 0, 0) 70%)',
          filter: 'blur(90px)',
      ...
      <div
        style={{
          ...
          height: '600px',
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(11, 25, 44, 0.55) 0%, rgba(10, 132, 255, 0) 70%)',
          filter: 'blur(100px)',
