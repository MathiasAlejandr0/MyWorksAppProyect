    ...
    <div className="devsecops-workspace">
      ...
      <div className="devsecops-kpi-row">
        ...
        <div className="devsecops-kpi card-surface">
          ...
          <span className="devsecops-kpi-sub">P95 Response Time</span>
          <svg className="devsecops-spark" viewBox="0 0 60 20" aria-hidden>
        ...
        <div className="devsecops-kpi card-surface">
          ...
          <strong>{dbReachable === false ? 'Degraded' : 'Excellent'}</strong>
          <span className="devsecops-kpi-sub up">All Systems Nominal</span>
          <svg className="devsecops-spark" viewBox="0 0 60 20" aria-hidden>
      ...
      <div className="devsecops-grid">
        <div className="card-surface devsecops-panel">
          ...
          <p className="devsecops-panel-foot">Executed 7 suites · 28 tests · 0 failures · 950ms</p>
        </div>

        <div className="card-surface devsecops-panel">
          <div className="devsecops-panel-head">
            <h3><Shield size={16} /> Security Scan: GitLeaks</h3>
            <span className="devsecops-panel-badge up">Completed</span>
          </div>
...
✓ No secrets detected. Repository is clean.`}</pre>
        ...
        <div className="card-surface devsecops-panel">
          ...
          <div className="devsecops-telemetry-stats">
            <div><span>Latency</span><strong>{latency ?? 24}ms</strong></div>
            <div><span>Requests</span><strong>142</strong></div>
            <div><span>Errors</span><strong>0</strong></div>
            <div><span>Throughput</span><strong>18.6 req/s</strong></div>
          </div>
        ...
        <div className="card-surface devsecops-panel">
          ...
          <p className="devsecops-mock-desc">
            Generate realistic mock data for testing and demonstration purposes.
          </p>
          <button type="button" className="btn-mock-generate">
            <FlaskConical size={18} /> Generate Mock Data
          </button>
          <div className="devsecops-mock-meta">
            <span>Dataset: University Demo</span>
      ...
      <aside className="devsecops-sidebar-info card-surface">
        <div className="devsecops-demo-badge"><GraduationCap size={14} /> Academic Demo</div>
        <p>Enterprise Tools Showcase</p>
        <div className="devsecops-env-card">
          <div><span className="live-pill-dot" aria-hidden /> Environment: Demo Lab</div>
          <div>User: researcher@myworks.edu <span className="badge-academic">Academic</span></div>
          <div className="devsecops-workspace-path">
            Workspace: /demo/devsecops-qa
      ...
      <footer className="devsecops-footer">
        Academic Demo Environment · Not for production use · Data may be reset periodically.
